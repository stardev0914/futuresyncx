    ...
    75740: function (e, t, r) {
      ...
      let s = Symbol(),
        ...
        p = (e, t, r, l) => {
          ...
          if (!i) {
            let t = u(e);
            (i = Object.values(Object.getOwnPropertyDescriptors(t)).some(
          ...
          return (
            (g && !!f === g[1].f) ||
              (((g = ((e, t) => {
                ...
                return t && (i.set = i.deleteProperty = () => !1), [i, r];
              })(c, !!f))[1].p = o(f || c, g[0])),
              r && r.set(c, g)),
            (g[1].a = t),
            (g[1].c = r),
        ...
        w = (
          ...
          i = [1, 1],
          a = (s) => {
            if (!b(s)) throw Error("object required");
            let n = l.get(s);
            if (n) return n;
            let c = i[0],
              d = new Set(),
              ...
              W = t(C, {
                ...
                set(t, s, n, o) {
                  let i = Reflect.has(t, s),
                    c = Reflect.get(t, s, o);
                  if (i && (e(c, n) || (l.has(n) && e(c, l.get(n))))) return !0;
                  I(s), b(n) && (n = g(n) || n);
                  let d = n;
      ...
      let W = I({
        ...
        E = {
          ...
          formatNativeUrl(e, t, r) {
            if (E.isHttpUrl(e)) return this.formatUniversalUrl(e, t, r);
            let s = e;
            s.includes("://") ||
          ...
          formatUniversalUrl(e, t, r) {
            if (!E.isHttpUrl(e)) return this.formatNativeUrl(e, t, r);
            let s = e;
            if (s.startsWith("https://t.me")) {
              let e = C.from(t).toString("base64").replace(/[=]/g, "");
          ...
          openHref(e, t) {
            let r = this.isTelegram() ? "_blank" : t;
            window.open(e, r, "noreferrer noopener");
          },
          setWalletConnectDeepLink(e, t) {
            try {
              localStorage.setItem(
                E.WALLETCONNECT_DEEPLINK_CHOICE,
          ...
          setModalVersionInStorage() {
            try {
              "undefined" != typeof localStorage &&
                localStorage.setItem(E.WCM_VERSION, "2.7.0");
            } catch (e) {
          ...
          getWalletRouterData() {
            var e;
            let t = null == (e = j.state.data) ? void 0 : e.Wallet;
        ...
        U = {
          ...
          setConfig(e) {
            var t, r;
            P.initialize(),
              D.setChains(e.chains),
              D.setIsAuth(Boolean(e.enableAuthMode)),
              D.setIsCustomMobile(
      ...
      var S = Object.defineProperty,
        ...
        _ = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        x = (e, t) => {
          for (var r in t || (t = {})) N.call(t, r) && _(e, r, t[r]);
          if (R) for (var r of R(t)) T.call(t, r) && _(e, r, t[r]);
          return e;
        };
      let $ = "https://explorer-api.walletconnect.com",
        B = "js-2.7.0";
      async function K(e, t) {
        let r = x({ sdkType: "wcm", sdkVersion: B }, t),
          s = new URL(e, $);
        s.searchParams.append("projectId", U.state.projectId),
      ...
      let V = {
        ...
        getWalletImageUrl: (e) =>
          `${$}/w3m/v1/getWalletImage/${e}?projectId=${U.state.projectId}&sdkType=wcm&sdkVersion=${B}`,
        getAssetImageUrl: (e) =>
          `${$}/w3m/v1/getAssetImage/${e}?projectId=${U.state.projectId}&sdkType=wcm&sdkVersion=${B}`,
      };
      var z = Object.defineProperty,
        ...
        F = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        G = (e, t) => {
          for (var r in t || (t = {})) J.call(t, r) && F(e, r, t[r]);
          if (H) for (var r of H(t)) q.call(t, r) && F(e, r, t[r]);
          return e;
        };
      let Q = E.isMobile(),
        X = I({
        ...
        Y = {
          ...
          async getRecomendedWallets() {
            ...
            if (E.isArray(e)) {
              let t = e.join(","),
                { listings: r } = await V.getAllListings({ recommendedIds: t }),
                s = Object.values(r);
              s.sort((t, r) => {
                ...
                (X.recomendedWallets = s);
            } else {
              let { chains: e, isAuth: r } = D.state,
                s = null == e ? void 0 : e.join(","),
                n = E.isArray(t),
                o = {
                  page: 1,
        ...
        ee = {
          ...
          open: async (e) =>
            new Promise((t) => {
              let { isUiLoaded: r, isDataLoaded: s } = D.state;
              if (
                (E.removeWalletConnectDeepLink(),
                D.setWalletConnectUri(null == e ? void 0 : e.uri),
                D.setChains(null == e ? void 0 : e.chains),
      ...
      var et = Object.defineProperty,
        ...
        eo = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        el = (e, t) => {
          for (var r in t || (t = {})) es.call(t, r) && eo(e, r, t[r]);
          if (er) for (var r of er(t)) en.call(t, r) && eo(e, r, t[r]);
          return e;
        };
      let ei = I({
          themeMode:
        ...
        ea = {
          ...
          setThemeConfig(e) {
            ...
            t && (ei.themeMode = t), r && (ei.themeVariables = el({}, r));
          },
        },
        ec = I({ open: !1, message: "", variant: "success" }),
        ed = {
          state: ec,
          subscribe: (e) => O(ec, () => e(ec)),
          openToast(e, t) {
            (ec.open = !0), (ec.message = e), (ec.variant = t);
          },
          closeToast() {
            ec.open = !1;
          },
      ...
      class n {
        ...
        async initUi() {
          if ("undefined" != typeof window) {
            await r.e(1391).then(r.bind(r, 41391));
