...
\f\r"'\`<>=]|("|')|))|$)`,
      ...
      class tt {
        ...
        _$AI(t, e = this, r, o) {
          let i = this.strings,
            n = !1;
          if (void 0 === i)
            (n = !T((t = Q(this, t, e, 0))) || (t !== this._$AH && t !== V)) &&
              (this._$AH = t);
          else {
            let o, l;
            let a = t;
            for (t = i[0], o = 0; o < i.length - 1; o++)
              (l = Q(this, a[r + o], e, o)) === V && (l = this._$AH[o]),
      ...
      class ti extends tt {
        ...
        _$AI(t, e = this) {
          var r;
          if (
            (t = null !== (r = Q(this, t, e, 0)) && void 0 !== r ? r : Z) === V
          )
            return;
          let o = this._$AH,
            i =
          ...
          get: (t, e) => {
            ...
            switch (e) {
              ...
              case "finished":
                return (
                  t.finished ||
                    (t.finished = Promise.all(t.animations.map(tN)).catch(t_)),
                  t.finished
                );
              case "stop":
                return () => {
          ...
          let d = (function (
            ...
            return (
              ...
              (i) => {
                ...
                let l = 0;
                for (; l < o - 2 && !(i < e[l + 1]); l++);
                let a = tW(0, 1, tj(e[l], e[l + 1], i)),
                  s = ((n = l), tB(r) ? r[tU(0, r.length, n)] : r);
                return (a = s(a)), tD(t[l], t[l + 1], a);
              }
            );
          })(e, a, tB(r) ? r.map(tJ) : tO);
          (this.tick = (e) => {
            var r;
            let o = 0;
            (o =
      ...
      let eh = (t, e) => {
          ...
          for (let e = 0; e < o; e++) r += t(tj(0, o - 1, e)) + ", ";
      ...
      var eC = r(5905),
        ...
        eO = (t, e, r) =>
          e in t
            ...
            : (t[e] = r),
        eI = (t, e) => {
          for (var r in e || (e = {})) ek.call(e, r) && eO(t, r, e[r]);
          if (eE) for (var r of eE(e)) e_.call(e, r) && eO(t, r, e[r]);
          return t;
        };
      function eT() {
        return {
      ...
      let eL = class extends ts {
        ...
        render() {
          ...
          return (
            ...
            W`<button class="${tw(t)}" ?disabled="${this.disabled}" @click="${
              this.onClick
            }">${
              this.iconLeft
      ...
      let eU = class extends ts {
        ...
        render() {
          ...
          return W`<button ?disabled="${this.disabled}" class="${tw(
            t
          )}"><slot></slot></button>`;
        }
      };
      (eU.styles = [eM.globalCss, eB]),
        ez([tm({ type: Boolean })], eU.prototype, "disabled", 2),
        ez([tm()], eU.prototype, "variant", 2),
        (eU = ez([td("wcm-button-big")], eU));
      ...
      let eJ = class extends ts {
        render() {
          return W`<div class="wcm-toolbar-placeholder"></div><div class="wcm-toolbar">${eF.WALLET_CONNECT_LOGO} <button @click="${tA.jb.close}">${eF.CROSS_ICON}</button></div>`;
        }
      };
      (eJ.styles = [eM.globalCss, eq]),
        (eJ = ((t, e, r, o) => {
          for (
      ...
      let e4 = class extends ts {
        render() {
          return W`<footer><slot></slot></footer>`;
        }
      };
      (e4.styles = [eM.globalCss, e1]),
        (e4 = ((t, e, r, o) => {
          for (
        ...
        })([td("wcm-modal-footer")], e4));
      let e3 = c`header{display:flex;justify-content:center;align-items:center;padding:20px;position:relative}.wcm-border{border-bottom:1px solid var(--wcm-color-bg-2);margin-bottom:20px}header button{padding:15px 20px}header button:active{opacity:.5}@media(hover:hover){header button:hover{opacity:.5}}.wcm-back-btn{position:absolute;left:0}.wcm-action-btn{position:absolute;right:0}path{fill:var(--wcm-accent-color)}`;
      ...
      let e9 = class extends ts {
        ...
        backBtnTemplate() {
          return W`<button class="wcm-back-btn" @click="${tA.AV.goBack}">${eF.BACK_ICON}</button>`;
        }
        actionBtnTemplate() {
        ...
        render() {
          let t = { "wcm-border": this.border },
            ...
            r = this.title
              ? W`<wcm-text variant="big-bold">${this.title}</wcm-text>`
              : W`<slot></slot>`;
          return W`<header class="${tw(t)}">${
            e ? this.backBtnTemplate() : null
          } ${r} ${this.onAction ? this.actionBtnTemplate() : null}</header>`;
        }
      };
      (e9.styles = [eM.globalCss, e3]),
      ...
      let rt = {
          ...
          handleMobileLinking(t, e = "_self") {
            ...
            rt.setRecentWallet(t),
              r &&
                (function (t) {
                  if (n) {
                    let r = tA.zv.formatNativeUrl(n, t, i);
                    tA.zv.openHref(r, e);
                  } else if (l) {
                    let r = tA.zv.formatUniversalUrl(l, t, i);
                    tA.zv.openHref(r, e);
                  }
                })(r);
          },
          handleAndroidLinking() {
            ...
            t &&
              ...
              tA.zv.openHref(t, tA.zv.isTelegram() ? "_blank" : "_self"));
          },
          async handleUriCopy() {
            let { walletConnectUri: t } = tA.zb.state;
            if (t)
          ...
          getCachedRouterWalletPlatforms() {
            let { desktop: t, mobile: e } = tA.zv.getWalletRouterData(),
              ...
              i =
                Boolean(null == e ? void 0 : e.native) ||
                Boolean(null == e ? void 0 : e.universal);
      ...
      let rw = class extends ts {
        ...
        svgTemplate() {
          let t = "light" === tA.Ic.state.themeMode,
            e = t ? this.size : this.size - 36;
          return H`<svg height="${e}" width="${e}">${ru.generate(
            this.uri,
            e,
            e / 4
          )}</svg>`;
        ...
        render() {
          ...
          return W`<div style="${`width: ${this.size}px`}" class="${tw(t)}">${
            this.walletId || this.imageUrl
              ? W`<wcm-wallet-image walletId="${e$(
                  this.walletId
      ...
      let r$ = class extends ts {
        ...
        render() {
          return W`<input type="text" @input="${this.onChange}" placeholder="Search wallets"> ${eF.SEARCH_ICON}`;
        }
      };
      ...
      let rM = class extends ts {
        ...
        render() {
          ...
          return W`<span><slot class="${tw(t)}"></slot></span>`;
        }
      };
      (rM.styles = [eM.globalCss, r_]),
      ...
      let rL = class extends ts {
        ...
        sublabelTemplate() {
          return this.recent
            ? W`<wcm-text class="wcm-sublabel" variant="xsmall-bold" color="tertiary">RECENT</wcm-text>`
            : this.installed
            ? W`<wcm-text class="wcm-sublabel" variant="xsmall-bold" color="tertiary">INSTALLED</wcm-text>`
            : null;
        }
        handleClick() {
        ...
        render() {
          var t;
          return W`<button @click="${this.handleClick.bind(
            this
      ...
      let rU = class extends ts {
        ...
        render() {
          ...
          return W`${
            e.length
              ? W`<div><img crossorigin="anonymous" src="${e}" alt="${this.id}"></div>`
              : eF.WALLET_PLACEHOLDER
          }`;
        }
      };
      (rU.styles = [eM.globalCss, rB]),
        rz([tm()], rU.prototype, "walletId", 2),
        rz([tm()], rU.prototype, "imageId", 2),
        rz([tm()], rU.prototype, "imageUrl", 2),
        (rU = rz([td("wcm-wallet-image")], rU));
      ...
      let rG = class extends ts {
        ...
        render() {
          ...
          return W`<wcm-modal-header title="Connect your wallet" .onAction="${
            this.onGoToQrcode
          }" .actionIcon="${
            eF.QRCODE_ICON
            ...
            let o = e[r % e.length];
            return o
              ? W`<wcm-wallet-image walletId="${o.id}" imageId="${o.image_id}"></wcm-wallet-image>`
              : eF.WALLET_PLACEHOLDER;
      ...
      let r5 = class extends ts {
        ...
        svgLoaderTemplate() {
          ...
          let i = 317 - 1.57 * o,
            n = 425 - 1.8 * o;
          return W`<svg viewBox="0 0 110 110" width="110" height="110"><rect id="wcm-loader" x="2" y="2" width="106" height="106" rx="${o}"/><use xlink:href="#wcm-loader" stroke-dasharray="106 ${i}" stroke-dashoffset="${n}"></use></svg>`;
        }
        render() {
          let t = { "wcm-error": this.isError, "wcm-stale": this.isStale };
          return W`<div class="${tw(
            t
      ...
      let r4 = {
          manualWallets() {
            ...
            let { mobileWallets: r, desktopWallets: o } = tA.t0.state,
              i = null == (t = r4.recentWallet()) ? void 0 : t.id,
        ...
        r3 = {
          ...
          manualWalletsTemplate() {
            let t = r4.manualWallets();
            return t.map(
              (t) =>
                W`<wcm-wallet-button walletId="${t.id}" name="${
                  t.name
                }" .onClick="${() =>
          ...
          recomendedWalletsTemplate(t = !1) {
            let e = r4.recomendedWallets(t);
            return e.map(
              (t) =>
                W`<wcm-wallet-button name="${t.name}" walletId="${
                  t.id
          ...
          recentWalletTemplate() {
            let t = r4.recentWallet();
            if (t)
              return W`<wcm-wallet-button name="${t.name}" walletId="${
                t.id
      ...
      let r9 = class extends ts {
        render() {
          let { explorerExcludedWalletIds: t, enableExplorer: e } = tA.t0.state,
            ...
            o = r3.recomendedWalletsTemplate(),
            i = r3.recentWalletTemplate(),
            n = [i, ...r, ...o];
          n = n.filter(Boolean);
          let l = n.length > 4 || ("ALL" !== t && e),
            a = [];
          a = l ? n.slice(0, 3) : n;
          let s = Boolean(a.length);
          return W`<wcm-modal-header .border="${!0}" title="Connect your wallet" .onAction="${
            rt.handleUriCopy
          }" .actionIcon="${
            eF.COPY_ICON
            ...
            s
              ? W`<wcm-modal-footer><div class="wcm-desktop-title">${
                  eF.DESKTOP_ICON
                }<wcm-text variant="small-regular" color="accent">Desktop</wcm-text></div><div class="wcm-grid">${a} ${
                  l
                    ? W`<wcm-view-all-wallets-button></wcm-view-all-wallets-button>`
                    : null
      ...
      let oo = class extends ts {
        render() {
          ...
          return (null != t ? t : e)
            ? W`<div><wcm-text variant="small-regular" color="secondary">By connecting your wallet to this app, you agree to the app's ${
                t
                  ? W`<a href="${t}" target="_blank" rel="noopener noreferrer">Terms of Service</a>`
                  : null
              } ${t && e ? "and" : null} ${
                e
                  ? W`<a href="${e}" target="_blank" rel="noopener noreferrer">Privacy Policy</a>`
                  : null
              }</wcm-text></div>`
            : null;
        }
      ...
      let ou = class extends ts {
        ...
        render() {
          ...
          return W`<wcm-explorer-context></wcm-explorer-context><wcm-theme-context></wcm-theme-context><div id="wcm-modal" class="${tw(
            t
          )}" @click="${
            this.onCloseModal
          }" role="alertdialog" aria-modal="true"><div class="wcm-container" tabindex="0">${
            this.open
              ? W`<wcm-modal-backcard></wcm-modal-backcard><div class="wcm-card"><wcm-modal-router></wcm-modal-router><wcm-modal-toast></wcm-modal-toast></div>`
              : null
          }</div></div>`;
        }
      };
      ...
      let ow = class extends ts {
        ...
        render() {
          return W`<div>${this.isRetry ? W`<slot></slot>` : null} ${
            this.isMobile
              ? W`<wcm-button .onClick="${this.onMobile}" .iconLeft="${eF.MOBILE_ICON}" variant="outline">Mobile</wcm-button>`
              : null
          } ${
            this.isDesktop
              ? W`<wcm-button .onClick="${this.onDesktop}" .iconLeft="${eF.DESKTOP_ICON}" variant="outline">Desktop</wcm-button>`
              : null
          } ${
            this.isWeb
              ? W`<wcm-button .onClick="${this.onWeb}" .iconLeft="${eF.GLOBE_ICON}" variant="outline">Web</wcm-button>`
              : null
          }</div>`;
        }
      };
      ...
      let ox = class extends ts {
        ...
        render() {
          ...
          return W`<button @click="${
            this.onClick
          }"><div class="wcm-icons">${r.map((t) => {
            let e = rt.getWalletIcon(t);
            if (e) return W`<img crossorigin="anonymous" src="${e}">`;
            let r = rt.getWalletIcon({ id: t.id });
            return r
              ? W`<img crossorigin="anonymous" src="${r}">`
              : eF.WALLET_PLACEHOLDER;
      ...
      let ok = class extends ts {
        ...
        render() {
          return W`<div class="wcm-qr-container">${
            this.uri
              ? W`<wcm-qrcode size="${this.overlayEl.offsetWidth}" uri="${
                  this.uri
                }" walletId="${e$(this.walletId)}" imageId="${e$(
                  this.imageId
                )}"></wcm-qrcode>`
              : W`<wcm-spinner></wcm-spinner>`
          }</div>`;
        }
      };
      (ok.styles = [eM.globalCss, o$]),
        oE([tm()], ok.prototype, "walletId", 2),
        oE([tm()], ok.prototype, "imageId", 2),
        oE([tp()], ok.prototype, "uri", 2),
        (ok = oE([td("wcm-walletconnect-qr")], ok));
      var o_ = Object.defineProperty,
        oO = Object.getOwnPropertyDescriptor;
      let oI = class extends ts {
        viewTemplate() {
          return tA.zv.isAndroid() && !tA.zv.isTelegram()
            ? W`<wcm-android-wallet-selection></wcm-android-wallet-selection>`
            : tA.zv.isMobile()
            ? W`<wcm-mobile-wallet-selection></wcm-mobile-wallet-selection>`
            : W`<wcm-desktop-wallet-selection></wcm-desktop-wallet-selection>`;
        }
        render() {
      ...
      let oN = class extends ts {
        ...
        render() {
          ...
          return W`<wcm-modal-header title="${t}" .onAction="${
            rt.handleUriCopy
          }" .actionIcon="${
            eF.COPY_ICON
      ...
      let oD = class extends ts {
        ...
        render() {
          ...
          return W`<wcm-modal-header title="${t}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${e$(
            r
      ...
      let oH = class extends ts {
        ...
        onFormatAndRedirect(t, e = !1) {
          let { mobile: r, name: o } = tA.zv.getWalletRouterData(),
            ...
            l = tA.zv.isTelegram() ? "_blank" : "_self";
          if (
            ((t =
              tA.zv.isTelegram() && tA.zv.isAndroid()
        ...
        openMobileApp(t = !1) {
          ...
          e && this.onFormatAndRedirect(e, t), rt.setRecentWallet(r);
        }
        onGoToAppStore(t) {
          t && tA.zv.openHref(t, "_blank");
        }
        render() {
          ...
          return W`<wcm-modal-header title="${t}"></wcm-modal-header><wcm-modal-content><wcm-connector-waiting walletId="${e}" imageId="${e$(
            ...
            a
              ? W`<wcm-text color="secondary" variant="small-thin">Still doesn't work? <span tabindex="0" @click="${() =>
                  this.openMobileApp(
                    !0
      ...
      (oH.styles = [eM.globalCss, oj]),
        oW([tp()], oH.prototype, "isError", 2),
        (oH = oW([td("wcm-mobile-connecting-view")], oH));
      ...
      var oK = Object.defineProperty,
        oY = Object.getOwnPropertyDescriptor;
      let oJ = class extends ts {
        render() {
          return W`<wcm-modal-header title="Scan the code" .onAction="${rt.handleUriCopy}" .actionIcon="${eF.COPY_ICON}"></wcm-modal-header><wcm-modal-content><wcm-walletconnect-qr></wcm-walletconnect-qr></wcm-modal-content>`;
        }
      };
      (oJ.styles = [eM.globalCss]),
        (oJ = ((t, e, r, o) => {
          for (
            var i, n = o > 1 ? void 0 : o ? oY(e, r) : e, l = t.length - 1;
            l >= 0;
      ...
      let o1 = class extends ts {
        ...
        render() {
          let { wallets: t, search: e } = tA.uc.state,
            ...
            n = r3.manualWalletsTemplate(),
            l = r3.recomendedWalletsTemplate(!0);
          i &&
            ((n = n.filter(({ values: t }) =>
          ...
          return W`<wcm-modal-header><wcm-search-input .onChange="${this.onSearchChange.bind(
            this
            ...
            o
              ...
              : r.map(
                  (t) =>
                    W`${
                      t
                        ? W`<wcm-wallet-button imageId="${t.image_id}" name="${
                            t.name
            ...
            a
              ? W`<wcm-text variant="big-bold" color="secondary">No results found</wcm-text>`
              : null
          } ${
            !a && this.loading ? W`<wcm-spinner></wcm-spinner>` : null
          }</div></wcm-modal-content>`;
        }
      };
      (o1.styles = [eM.globalCss, oQ]),
      ...
      var o5 = Object.defineProperty,
        ...
        o3 = (t, e, r, o) => {
          for (
            var i, n = o > 1 ? void 0 : o ? o4(e, r) : e, l = t.length - 1;
            l >= 0;
            l--
          )
            (i = t[l]) && (n = (o ? i(e, r, n) : i(n)) || n);
      ...
      (o7.styles = [eM.globalCss, o2]),
        o3([tp()], o7.prototype, "isError", 2),
        (o7 = o3([td("wcm-web-connecting-view")], o7));
    },
  },
]);
